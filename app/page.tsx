  ...
  return (
    <>
      ...
      <main className="max-w-5xl mx-auto px-6 py-10">
        <nav className="flex flex-wrap justify-between items-center gap-y-4 mb-16">
          <div className="text-xl font-medium">
            markappscript<span className="text-accent">.dev</span>
          </div>
          <div className="flex gap-6 text-sm text-neutral-600 dark:text-neutral-400 items-center w-full sm:w-auto justify-between sm:justify-end">
            <div className="flex gap-6">
              <a href="#work" className="link-underline hover:text-neutral-900 dark:hover:text-neutral-100 transition-colors">
                Work
              </a>
              <a href="#about" className="link-underline hover:text-neutral-900 dark:hover:text-neutral-100 transition-colors">
                About
              </a>
              <a href="#contact" className="link-underline hover:text-neutral-900 dark:hover:text-neutral-100 transition-colors">
                Contact
              </a>
            </div>
            <ThemeToggle />
        ...
        {/* HERO — asymmetric, type-led, one dominant element instead of a boxed card */}
        ...
        {/* ABOUT — story-led, keeps the wit from the hero */}
        <FadeInSection>
        ...
        {/* CONTACT — one clear set of links, no form to maintain */}
        <FadeInSection>
